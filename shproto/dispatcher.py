...
####
			...
			print("elapsed: {}/{:.0f} cps: {}/{:.2f} total_pkts: {} drop_pkts: {} "
...
#			if (shproto.dispatcher.total_time>58):
	...
	if shproto.dispatcher.csv_out:
		...
		with open(filename, "w") as fd:
			if shproto.dispatcher.interspec_csv:
				...
				fd.writelines("detectorname,nano15-8k-{}\nSerialNumber,nano15-8k-{}\n".format(shproto.dispatcher.serial_number, shproto.dispatcher.serial_number))
